			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						...
						<p>Leave your messages and we'll get back to you!</p>
					</div>
				</div>
				<form action="#">
					<div class="row animate-box">
						<div class="col-md-6">
							...
							<p>A galaxy far, far away, behind the mountains, far from the countries</p>
							<ul class="contact-info">
								<li><i class="icon-location-pin"></i>198 West 21th Street, Bangalore</li>
								<li><i class="icon-phone2"></i>+ 1212 2323 45</li>
