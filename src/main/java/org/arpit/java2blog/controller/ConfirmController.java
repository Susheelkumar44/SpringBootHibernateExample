...
public class ConfirmController  {
	...
	public String getAllCustomers(Model model,@RequestParam String pc,@RequestParam String travelClass,@RequestParam double cost,@RequestParam int id){
		List<Flights> listFlights = bookingService.getFlight(id);
